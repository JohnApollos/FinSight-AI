...
def main():
    ...
    try:
        import backend.app.utils.damodaran_downloader as damodaran_downloader
    ...
    try:
        import backend.app.utils.process_benchmarks as process_benchmarks
    ...
    try:
        import backend.app.utils.sec_downloader as sec_downloader
    ...
    try:
        import backend.app.utils.train_model as train_model
